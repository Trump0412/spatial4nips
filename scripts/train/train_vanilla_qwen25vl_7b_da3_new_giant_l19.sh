#!/bin/bash
# 7B Vanilla ablation: DA3-GIANT + out_layer_index=0 (layer 19, shallowest out_layer for vitg)
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"${PROJECT_ROOT}/outputs/vanilla_qwen25vl_7b_da3_new_giant_l19"}
LOG_DIR=${LOG_DIR:-"${PROJECT_ROOT}/logs/vanilla_qwen25vl_7b_da3_new_giant_l19"}
