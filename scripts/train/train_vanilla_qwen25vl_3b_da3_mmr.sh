...
VARIANT_NAME=${VARIANT_NAME:-"vanilla_qwen25vl_3b_da3_mmr"}
...
GEO_INJECT_VERSION=${GEO_INJECT_VERSION:-"da3_mmr"}
...
BASE_EXTRA_ARGS="--mmr_use_region_memory False --mmr_frame_topk_max 3 --mmr_region_topk_max 8 --mmr_use_view_continuity True --mmr_use_temporal_continuity True --mmr_region_atoms_per_frame 8 --mmr_query_use_text True --mmr_query_use_visual_summary True"
