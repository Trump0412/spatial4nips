...
PROJECT_ROOT=${PROJECT_ROOT:-"/data/code/spatial4nips"}
CHECKPOINT_ROOT=${CHECKPOINT_ROOT:-"/data/hf/models"}
MODEL_ROOT=${MODEL_ROOT:-"/data/hf/models"}
...
GEOMETRY_ENCODER_PATH=${GEOMETRY_ENCODER_PATH:-"/data/hf/models/DA3-GIANT-1.1"}
