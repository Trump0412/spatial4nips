#!/bin/bash
# 3B Vanilla: ZenView (DA3-new output + MSGF + temporal bonus + atom refinement)
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"${PROJECT_ROOT}/outputs/vanilla_qwen25vl_3b_da3_msgf_temporal_refine"}
LOG_DIR=${LOG_DIR:-"${PROJECT_ROOT}/logs/vanilla_qwen25vl_3b_da3_msgf_temporal_refine"}
