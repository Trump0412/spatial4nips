...
VARIANT_NAME=${VARIANT_NAME:-"vanilla_qwen25vl_3b_da3_hmsgf"}
...
GEO_INJECT_VERSION=${GEO_INJECT_VERSION:-"da3_hmsgf"}
...
BASE_EXTRA_ARGS="--hmsgf_frame_topk_max 3 --hmsgf_region_topr 32 --hmsgf_region_topk_max 8"
