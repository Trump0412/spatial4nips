...
class Qwen3VLProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, video_processor=None, chat_template=None, 
                 depart_smi_token=False, smi_image_num=8, smi_downsample_rate=2, **kwargs):
        ...
        **kwargs: Unpack[Qwen3VLProcessorKwargs],
        ...
        if image_grid_thw is not None:
            ...
            for i in range(len(text)):
                ...
                if self.depart_smi_token and len(text[i].split(self.image_token)) > (self.smi_image_num+1): 
                    merge_size = merge_length * self.smi_downsample_rate
                else: merge_size = merge_length

                while self.image_token in text[i]:
                    num_image_tokens = image_grid_thw[index][0] * (image_grid_thw[index][1] // merge_size) * (image_grid_thw[index][2] // merge_size)
        ...
        if video_grid_thw is not None:
            merge_length = self.video_processor.merge_size
            index = 0
            for i in range(len(text)):
                
                if self.depart_smi_token and len(text[i].split(self.video_token)) > (self.smi_image_num+1): 
                    merge_size = merge_length * self.smi_downsample_rate
                else: merge_size = merge_length
                ...
                while self.video_token in text[i]:
                    ...
                    frame_seqlen = (video_grid_thw[index][1] // merge_size) * (video_grid_thw[index][2] // merge_size)
