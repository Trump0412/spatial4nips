...
class ModelArguments:
    ...
    mmr_write_start: int = field(default=8)
    mmr_write_end: int = field(default=15)
    mmr_read_start: int = field(default=16)
    mmr_read_end: int = field(default=20)
    mmr_use_view_continuity: bool = field(default=True)
    mmr_use_temporal_continuity: bool = field(default=True)
    mmr_memory_dim: int = field(default=-1)
